...
/// Permet de recuperer la configuration du serveur en fonction de la configuration annoté dans le fichier
/// ConfigServeur.ini
/// \return Struct config contenant la configuration des parties
